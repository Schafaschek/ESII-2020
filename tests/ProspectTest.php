...
class ProspectTest extends TestCase{
   ...
   public function testIncluirProspect(){
      ...
      try{
         $this->assertEquals(
            TRUE,
            $daoProspect->incluirProspect("Bruno Schafaschek", "bruno@gmail.com", "(47)93496-5243", "/brunoschafaschek", "(47)93496-5243")
         );
         unset($usuario);
      }catch(\Exception $e){
   ...
   public function atualizarProspect(){
      ...
      $this->assertEquals(
         TRUE,
         $daoProspect->atualizarProspect('Pedro Pedroso', 'pedro@gmail.com.br', '(49)93463-3248',  'facepedro', '(49)3395-6589', 3)
      );
      unset($daoProspect);
   }
   /** @test */
